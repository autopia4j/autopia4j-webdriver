...
REM java -jar "H:\Javalibs\Selenium\selenium-server-standalone-2.48.2.jar" -role node -hub http://<IP-Address-Of-Grid-Hub>:<Port>/grid/register -Dwebdriver.ie.driver="H:\\Javalibs\\Selenium\\Browser Drivers\\IEDriverServer.exe" -Dwebdriver.chrome.driver="H:\\Javalibs\\Selenium\\Browser Drivers\\chromedriver.exe"
...
REM java -jar "H:\Javalibs\Selenium\selenium-server-standalone-2.48.2.jar" -role node -hub http://<IP-Address-Of-Grid-Hub>:<Port>/grid/register -Dwebdriver.firefox.bin="C:\\Users\\X193663\\AppData\\Local\\Mozilla Firefox\\firefox.exe"
