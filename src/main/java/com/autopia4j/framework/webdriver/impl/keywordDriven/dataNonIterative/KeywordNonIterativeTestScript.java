 ...
 * @author vj
 */
public abstract class KeywordNonIterativeTestScript extends TestScript {
	/**
	...
	private ThreadLocal<KeywordNonIterativeDriverScript> currentDriverScript = new ThreadLocal<>();
	 ...
	 * @param driverScript The {@link KeywordNonIterativeDriverScript} object
	 */
	protected void assertTestPassed(KeywordNonIterativeDriverScript driverScript) {
	...
	public synchronized void tearDownTestRunner() {
		KeywordNonIterativeDriverScript driverScript = currentDriverScript.get();
